...
COPY frontend/ ./
# We set this to /api so Axios requests point relative to the monolith origin
...
# Run database migrations, then start the server from the compiled dist directory
